...
abstract class Posts implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PostsTableMap';
    ...
    /**
     * The value for the post_image_url field.
     * 
     * @var        string
     */
    ...
    /**
     * The value for the times_visited field.
     * 
     * @var        int
     */
    ...
    /**
     * Initializes internal state of Base\Posts object.
     */
    ...
    /**
     * Get the [post_image_url] column value.
     * 
     * @return string
     */
    ...
    /**
     * Get the [times_visited] column value.
     * 
     * @return int
     */
     ...
     * @return $this|\Posts The current object (for fluent API support)
     */
    public function setPostId($v)
    {
        ...
        if ($this->post_id !== $v) {
            $this->post_id = $v;
            $this->modifiedColumns[PostsTableMap::COL_POST_ID] = true;
        }
    ...
    public function setPostTitle($v)
    {
        ...
        if ($this->post_title !== $v) {
            $this->post_title = $v;
            $this->modifiedColumns[PostsTableMap::COL_POST_TITLE] = true;
        }
    ...
    /**
     * Set the value of [post_image_url] column.
     * 
     * @param string $v new value
     * @return $this|\Posts The current object (for fluent API support)
     */
    public function setPostImageUrl($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->post_image_url !== $v) {
            $this->post_image_url = $v;
            $this->modifiedColumns[PostsTableMap::COL_POST_IMAGE_URL] = true;
        }
    ...
    public function setPostDate($v)
    {
        ...
        if ($this->post_date !== null || $dt !== null) {
            if ($this->post_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->post_date->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PostsTableMap::COL_POST_DATE] = true;
            }
    ...
    /**
     * Set the value of [times_visited] column.
     * 
     * @param int $v new value
     * @return $this|\Posts The current object (for fluent API support)
     */
    public function setTimesVisited($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->times_visited !== $v) {
            $this->times_visited = $v;
            $this->modifiedColumns[PostsTableMap::COL_TIMES_VISITED] = true;
        }
    ...
    public function setPostText($v)
    {
        ...
        if ($this->post_text !== $v) {
            $this->post_text = $v;
            $this->modifiedColumns[PostsTableMap::COL_POST_TEXT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PostsTableMap::translateFieldName('PostId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->post_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PostsTableMap::translateFieldName('PostTitle', TableMap::TYPE_PHPNAME, $indexType)];
            $this->post_title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PostsTableMap::translateFieldName('PostImageUrl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->post_image_url = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PostsTableMap::translateFieldName('PostDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->post_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PostsTableMap::translateFieldName('Active', TableMap::TYPE_PHPNAME, $indexType)];
            $this->active = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PostsTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : PostsTableMap::translateFieldName('TimesVisited', TableMap::TYPE_PHPNAME, $indexType)];
            $this->times_visited = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : PostsTableMap::translateFieldName('PostText', TableMap::TYPE_PHPNAME, $indexType)];
            $this->post_text = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Posts'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PostsTableMap::COL_POST_ID)) {
            $modifiedColumns[':p' . $index++]  = 'post_id';
        }
        if ($this->isColumnModified(PostsTableMap::COL_POST_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'post_title';
        }
        if ($this->isColumnModified(PostsTableMap::COL_POST_IMAGE_URL)) {
            $modifiedColumns[':p' . $index++]  = 'post_image_url';
        }
        if ($this->isColumnModified(PostsTableMap::COL_POST_DATE)) {
        ...
        if ($this->isColumnModified(PostsTableMap::COL_TIMES_VISITED)) {
            $modifiedColumns[':p' . $index++]  = 'times_visited';
        }
        if ($this->isColumnModified(PostsTableMap::COL_POST_TEXT)) {
            $modifiedColumns[':p' . $index++]  = 'post_text';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'post_title':                        
                        ...
                        break;
                    case 'post_image_url':                        
                        $stmt->bindValue($identifier, $this->post_image_url, PDO::PARAM_STR);
                        break;
                    case 'post_date':                        
                    ...
                    case 'user_id':                        
                        ...
                        break;
                    case 'times_visited':                        
                        $stmt->bindValue($identifier, $this->times_visited, PDO::PARAM_INT);
                        break;
                    case 'post_text':                        
                        $stmt->bindValue($identifier, $this->post_text, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getPostImageUrl(),
            $keys[3] => $this->getPostDate(),
            $keys[4] => $this->getActive(),
            $keys[5] => $this->getUserId(),
            $keys[6] => $this->getTimesVisited(),
            $keys[7] => $this->getPostText(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setPostTitle($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setPostImageUrl($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setPostDate($arr[$keys[3]]);
        }
        ...
        if (array_key_exists($keys[6], $arr)) {
            $this->setTimesVisited($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setPostText($arr[$keys[7]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PostsTableMap::COL_POST_ID)) {
            $criteria->add(PostsTableMap::COL_POST_ID, $this->post_id);
        }
        if ($this->isColumnModified(PostsTableMap::COL_POST_TITLE)) {
            $criteria->add(PostsTableMap::COL_POST_TITLE, $this->post_title);
        }
        if ($this->isColumnModified(PostsTableMap::COL_POST_IMAGE_URL)) {
            $criteria->add(PostsTableMap::COL_POST_IMAGE_URL, $this->post_image_url);
        }
        if ($this->isColumnModified(PostsTableMap::COL_POST_DATE)) {
            $criteria->add(PostsTableMap::COL_POST_DATE, $this->post_date);
        }
        if ($this->isColumnModified(PostsTableMap::COL_ACTIVE)) {
        ...
        if ($this->isColumnModified(PostsTableMap::COL_TIMES_VISITED)) {
            $criteria->add(PostsTableMap::COL_TIMES_VISITED, $this->times_visited);
        }
        if ($this->isColumnModified(PostsTableMap::COL_POST_TEXT)) {
            $criteria->add(PostsTableMap::COL_POST_TEXT, $this->post_text);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Posts (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPostImageUrl($this->getPostImageUrl());
        $copyObj->setPostDate($this->getPostDate());
        $copyObj->setActive($this->getActive());
        $copyObj->setUserId($this->getUserId());
        $copyObj->setTimesVisited($this->getTimesVisited());
        $copyObj->setPostText($this->getPostText());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Posts Clone of current object.
     * @throws PropelException
     */
     ...
     * Otherwise if this Posts is new, it will return
     * an empty collection; or if this Posts has previously
     * been saved, it will retrieve related Commentss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Posts.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    public function setCommentsDeleteds(Collection $commentsDeleteds, ConnectionInterface $con = null)
    {
        ...
        foreach ($commentsDeletedsToDelete as $commentsDeletedRemoved) {
            $commentsDeletedRemoved->setPosts(null);
        }
     ...
     * @return ObjectCollection|ChildCommentsDeleted[] List of ChildCommentsDeleted objects
     */
    public function getCommentsDeletedsJoinUsers(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCommentsDeletedQuery::create(null, $criteria);
        $query->joinWith('Users', $joinBehavior);
    ...
    {
        if (null !== $this->aUsers) {
            $this->aUsers->removePosts($this);
        }
        $this->post_id = null;
        $this->post_title = null;
        $this->post_image_url = null;
        $this->post_date = null;
        $this->active = null;
        $this->user_id = null;
        $this->times_visited = null;
        $this->post_text = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->resetModified();
